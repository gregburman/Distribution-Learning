...
file_1 = h5py.File('../snapshots/prob_unet/setup_21/prediction_00000000.hdf', 'r')
file_2 = h5py.File('../snapshots/prob_unet/setup_21/prediction_00000001.hdf', 'r')
file_3 = h5py.File('../snapshots/prob_unet/setup_21/prediction_00000002.hdf', 'r')
file_3 = h5py.File('../snapshots/prob_unet/setup_21/prediction_00000003.hdf', 'r')
